...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM public.methodic_questions) THEN
        ...
        RAISE NOTICE 'Inserted initial data into public.methodic_questions.';
    ELSE
        RAISE NOTICE 'Table public.methodic_questions already contains data. Skipping inserts.';
    END IF;
